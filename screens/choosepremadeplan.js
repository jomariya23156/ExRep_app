...
export default function ChoosePremadePlan({ navigation }) {
    ...
    <View style={styles.container}>
        ...
        <View style={styles.title}>
          <View style={styles.headerrow}>
            ...
            <Text style={styles.textheader}>Premade Plan</Text>
          </View> 
        </View>
        ...
        <View style={styles.content}>
          ...
          style={styles.list}
          renderItem={({ item }) => (
            <TouchableOpacity onPress={() => navigation.navigate('PremadeDetails',{id: item.id,title:item.title})}>
